...
CREATE TABLE `orders` (
  ...
  `order_amt` decimal(10,2) DEFAULT '0.00' COMMENT '订单金额',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uindex_order_no` (`order_no`)
) ENGINE=InnoDB AUTO_INCREMENT=266 DEFAULT CHARSET=utf8 COMMENT='订单';
...
CREATE TABLE `area` (
  ...
  `area_alias` varchar(50) DEFAULT NULL COMMENT '别名',
  `parent_area_id` varchar(20) DEFAULT NULL COMMENT '直接上级区域',
  PRIMARY KEY (`id`)
